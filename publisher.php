...
<html lang="en">
  ...
  <!-- Preference  -->
<form method="post" action="publisher.php" class="form-inline">
  <label class="mr-sm-2" for="inlineFormCustomSelectPref">Publisher Preference</label>
  <select name="alloption" class="custom-select mb-2 mr-sm-2 mb-sm-0" id="inlineFormCustomSelectPref">
<?php 
         while($row3 = $result3->fetch_assoc()){  
          $pubid=$row3['pub_id'];
          $pub=$row3['book_publisher'];  
          ?>
          <option value="<?php echo $pubid ?>"><?php echo $pub ?></option>
         <?php 
        }
